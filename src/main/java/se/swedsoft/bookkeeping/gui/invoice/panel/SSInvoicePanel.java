...
public class SSInvoicePanel {
    ...
    private boolean panelIsUpdated = false;
    ...
    public SSInvoicePanel(final SSDialog iOwner) {
        ...
        iPaymentTerm.getComboBox().addSelectionListener(
                new SSSelectionListener<SSPaymentTerm>() {
    ...
    public boolean isUpdated() {
        return panelIsUpdated | iInvoiceAddress.panelIsUpdated() | iDeliveryAddress.panelIsUpdated();
    }
